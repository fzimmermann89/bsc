...
\begin{figure}
	...
	\caption[Illustration MSFT]{Illustration zur MSFT: Das Streubild wird berechnet indem schichtweise der jeweilige Beitrag der Bornschen Näherung phasenkorrekt aufaddiert wird (dargestellt von links nach rechts). Das rechteste Bild ist somit das Streubild des Objektes und das Ergebnis des Algorithmus.}
...
\begin{figure}
	...
	\caption[Illustration Multislice Propagation]{Illustration zur Multislice Propagation: Dargestellt ist der Betrag der komplexen Wellenfront, die Strahlrichtung ist von links nach rechts. Das rechteste Bild ist die Austrittswelle hinter der Szene und das Ergebnis des Algorithmus.}
	\label{fig:msft}
\end{figure} 
