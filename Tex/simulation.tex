...
Thibault stellt in~\cite{thibault2007} eine eigene Formulierung der Multislice-Simulation auf. Ausgehend von der Wellengleichung (\fref{eq:wellengleichung_green})
...
\begin{figure}[htb!] %exitwave und scatter
	\centering
