...
\begin{figure} %exitwave und scatter
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\includegraphics[width=\textwidth]{images/fig_sim_exitwave_multislice-r100-bd1e-3.png}\llap{\makebox[\wd1][l]{\includegraphics[width=0.33\textwidth]{images/fig_sim_exitwave_multislice_cw-r100-bd1e-3.pdf}}}
...
\begin{figure}[b] %exitwave und scatter
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\includegraphics[width=\textwidth]{images/fig_simholo_v2_exitwave.png}\llap{\makebox[\wd1][l]{\includegraphics[width=0.33\textwidth]{images/fig_simholo_v2_exitwave_cw.pdf}}}
		\caption{Austrittswelle}
