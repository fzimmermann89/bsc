...
\begin{figure}
	...
	\caption[Illustration MSFT]{Illustration zur MSFT: Das Streubild in der untersten Reihe wird berechnet, indem schichtweise der jeweilige Beitrag der Bornschen Näherung phasenkorrekt aufaddiert wird (dargestellt von links nach rechts). Das Bild unten rechts außen ist somit das berechnete Streubild des Objektes und das Ergebnis des Algorithmus.}
