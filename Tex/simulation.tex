...
\begin{figure} %parameter variation
	...
	\caption[Gültigkeit der Simulationsalgorithmen]{Zur Entscheidung bei welchen Radien und welchen Abweichung der Brechzahl vom Vakuum die Simulationen noch valide sind, ist die mediane, relative Abweichung bis 20° von Mie über den Parametern aufgetragen. Es somit die Bereiche erkennbar, in denen der jeweilige Simulationsalgorithmus valide Ergebnisse liefert---Gelb entspricht 20\% Abweichung und kann als obere Grenze angesehen werden. Die Auflösung der Szene im Realraum wurde als $\Delta x=\dfrac{\lambda}{2}$, $\Delta z$ als $\dfrac{\lambda}{8}$ und N=2048 gewählt.}
	\label{fig:variation}
\end{figure}
