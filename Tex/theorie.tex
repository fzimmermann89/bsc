...
Wird in \fref{eq:angularspectrum} die Taylor-Näherung 2. Ordnung durchgeführt (\fref{eq:taylor} und \ref{eq:fresnel_fourier}) sowie eine zweidimensionale inverse Fouriertransformation angewendet, so erhält man mit dem Faltungstheorem die Fresnel-Näherung im Realraum (\fref{eq:fresnel_real}).
