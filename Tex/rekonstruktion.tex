...
Ist das Rauschen jedoch mit dem Signal korreliert, wie dies z.B. bei Poisson-Rauschen (Shot-Noise) der Fall ist, so lässt sich eine heuristische Form des Wiener-Filters mit konstantem,  XX anwenden. Hierbei muss ein Kompromiss aus Rauschunterdrückung und Entfaltung gewählt werden.
