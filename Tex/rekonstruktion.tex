...
\begin{figure}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\caption{große Maske}	
	\end{subfigure}
	\caption{Einfluss einer zentralen Maskierung des Streubildes mit Radius 16 Pixel bzw. 64 Pixel von 2048 Pixeln auf die Rekonstruktionen (gleiche Anordnung wie in \fref{fig:recon2d-perfect}). Z}
...
\begin{figure}
	...
	\end{subfigure}
	\caption{Einfluss des Rauschen: Das gering maskierte Streubild wurde mit 15\,Bit bzw 14\,Bit diskretiesiert und Poisson-Shot-Rauschen hinzugefügt.}
\end{figure}
...
%		\includegraphics[width=\textwidth]{images/recon2d-mask16bit16error05.png}
	...
	\end{subfigure}
	\caption{Einfluss von ungenauer Referenzabschätzung: Das gering verrauschte und maskierte Streubild wird mit einem andren Radius der kreisförmigen Referenz rekonstruiert. Dies hat nur einen Einfluss auf die Entfaltung.}
\end{figure}
