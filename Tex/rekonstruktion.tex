...
\begin{SCfigure}
	...
	\caption[Prinzip Wiener-Enfaltung]{Prinzip der Wiener Entfaltung. Das Betragsquadrat im Fourierraum entspricht einer Faltung des Signals mit der Referenz im Realraum. Zur Entfaltung wird im Fourierraum durch die Referenz geteilt. XXX TODO - \textit{Hier muss noch die Fourierraum darstellung rein} XXX}
	\label{fig:wiener}
\end{SCfigure} 
