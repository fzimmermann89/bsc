...
\begin{figure}
	\centering
	\quadimage{[width=.75\textwidth,trim=30 30 30 30,clip]{images/recon3d.png}}
	\caption[Rekonstruktion einer Austrittswelle]{Die Rekonstruktion der Austrittswelle in \fref{fig:komplex}. Dargestellt ist jeweils der Betrag der Abweichung von der einfallenden Wellen. a) optimale Ergebnis zum Vergleich, b) die Rekonstruktion mittels iterativer Rekonstruktion und Shrink-Wrap, c) mittels Entfaltung, d) das Ergebnis nach iterativer Phasenrekonstruktion mit Holographie}
	\label{fig:recon3d}
\end{figure}	
